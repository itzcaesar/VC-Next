...
| Stability | Adaptive playback priming, bounded clock-drift correction, underrun recovery, callback-error route restart, device-loss detection, and supervised Python-worker restart |
